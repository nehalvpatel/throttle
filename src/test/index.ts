...
describe("#throttle", function () {
  ...
  class MockLruCache {
    constructor(options: any) {
      this._constructorCalled(options);
    }
    _constructorCalled(options: any) {}
    get() {
      return { value: 1 };
    }
    set() {}
  ...
  before(function () {
    ...
    throttle = require("../index").throttle;
  });
  ...
  it("Should call resolver", function () {
    ...
    resolver.withArgs(2).onFirstCall().returns(2).onSecondCall().returns(3);
  ...
  it("Should use LruCache when maxSize option is set", function () {
    ...
    const constructor = sandbox.spy(
      MockLruCache.prototype,
      "_constructorCalled"
    );
